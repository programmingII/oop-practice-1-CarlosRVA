...
class Ejercicio10{
public static void main(String[]args){/*Se crea el método main para poder iniciar el programa y se le asignan atributos
como la disponibilidad de uso, valores de retorno y argumentos.*/
