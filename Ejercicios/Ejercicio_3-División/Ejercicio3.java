...
class Ejercicio3{
public static void main(String[]args){/*Se crea el método que permite la ejecución del programa y se le agregan los
atributos de disponibilidad de uso, argumentos y valores de retorno.*/
